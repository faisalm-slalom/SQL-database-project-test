...
Create PROCEDURE [dbo].[SF_ConvertLeads]
...
set @errorLines = 'SF_ConvertLeads Error: '
set NOCOUNT ON

print '--- Starting SF_ConvertLeads for ' + @table_name + ' ' +  dbo.SF_Version()
declare @LogMessage nvarchar(max)
declare @SPName nvarchar(50)
set @SPName = 'SF_ConvertLeads:' + Convert(nvarchar(255), NEWID(), 20)
set @LogMessage = 'Parameters: ' + @table_server + ' ' + @table_name + ' ' + @options + ' ' + ' Version: ' +  dbo.SF_Version()
...
declare @operation nvarchar(200) = 'convertlead'
...
print '--- Ending SF_ConvertLeads. Operation successful.'
...
print '--- Ending SF_ConvertLeads. Operation FAILED.'
